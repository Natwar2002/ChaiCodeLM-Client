...
const TOAST_LIMIT = 3; // Allow more toasts to stack
const TOAST_REMOVE_DELAY = 1000; // 1 second delay after dismiss for smooth animation
const TOAST_AUTO_DISMISS_DELAY = 3000; // 3 seconds to auto-dismiss
